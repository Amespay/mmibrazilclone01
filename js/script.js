...
(function () {
      ...
      for ( var i = 0; i < plugins.waves.length; i++ ) {
        ...
        var waves = new SineWaves({
          ...
          resizeEvent: function() {
            ...
            gradient1.addColorStop(0,"rgba(166, 109, 32, 1)");
            gradient1.addColorStop(0.54,"rgba(218, 165, 32, 1)");
            gradient1.addColorStop(1,"rgba(232, 172, 22, 1)");

            var gradient2 = this.ctx.createLinearGradient(0, 0, this.width, 0);
            gradient2.addColorStop(0,"rgba(39, 84, 53, 1)");
            gradient2.addColorStop(0.50,"rgba(31, 65, 41, 1)");
            gradient2.addColorStop(1,"rgba(21, 45, 28, 1)");
  ...
  $(function () {
    ...
    function liveSearch(options) {
      ...
      options.current++;
      options.spin.addClass('Carregando');
      $.get(handler, {
        ...
        options.spin.parents('.rd-search').find('.input-group-addon').removeClass('Carregando');
      })
    }
    ...
    if (plugins.statefulButton.length) {
      $(plugins.statefulButton).on('click', function () {
        var statefulButtonCarregando = $(this).button('Carregando');

        setTimeout(function () {
          statefulButtonCarregando.button('reset')
        }, 2000);
      })
    }
    ...
    if ( plugins.rdNavbar.length ) {
      ...
      for ( var alias in aliases ) {
        ...
        if ( navbar.attr( 'data'+ alias +'auto-height' ) )     link.autoHeight    = navbar.attr( 'data'+ alias +'auto-height' ) === 'false';
